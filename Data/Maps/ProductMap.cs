...
namespace ProductCatalog.Data.Maps
{
    public class ProductMap : IEntityTypeConfiguration<Product>
    {
        ...
        public void Configure(EntityTypeBuilder<Product> builder)
        {
            ...
            builder.Property(x => x.Description).IsRequired().HasMaxLength(1024).HasColumnName("varchar(1024)");
            builder.Property(x => x.Image).IsRequired().HasMaxLength(1024).HasColumnName("varchar(1024)");
